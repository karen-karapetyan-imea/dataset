...
def test_build_artist_row() -> None:
    ...
    assert row["artist_url"] == (
        "https://www.artsper.com/us/contemporary-artists/france/128876/nathalie-cubero"
    )
...
def test_build_artwork_row() -> None:
    ...
    assert row["artwork_url"] == (
        "https://www.artsper.com/us/contemporary-artworks/painting/2361374/x"
    )
